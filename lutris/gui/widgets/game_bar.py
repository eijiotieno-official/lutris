...
class GameBar(Gtk.Box):
    ...
    def get_popover_box(primary_button, popover_buttons, primary_opens_popover=False):
        ...
        if popover_buttons:
            ...
            popover_button.set_direction(Gtk.ArrowType.UP)
            popover_button.set_visible(True)
    ...
    def get_link_button(self, text, callback=None):
        ...
        button = Gtk.Button(label=text, visible=True)
    ...
    def get_runner_button(self):
        ...
        if runner_popover_buttons:
            ...
            runner_button.set_child(runner_icon)
            runner_button.set_visible(True)
    ...
    def get_last_played_label(self):
        ...
        last_played_label.set_yalign(0.5)
