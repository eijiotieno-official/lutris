...
class IssueReportWindow(BaseApplicationWindow):
    ...
    def __init__(self, application):
        ...
        issue_entry_label.set_wrap(True)
        ...
        action_buttons_box = Gtk.Box()
        action_buttons_box.set_halign(Gtk.Align.END)
        action_buttons_box.append(self.action_buttons)
        self.vbox.append(action_buttons_box)
    ...
    def on_save(self, _button):
        ...
        save_dialog = Gtk.FileDialog(title=_("Select a location to save the issue"))
        save_dialog.select_folder(self, None, self.on_folder_selected)
