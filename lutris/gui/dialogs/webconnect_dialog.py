...
class WebConnectDialog(ModalDialog):
    ...
    def __init__(self, service: "OnlineService", parent=None):
        ...
        WebKit.CookieManager.set_persistent_storage(
            self.network_session.get_cookie_manager(),
        ...
        self.webview = GObject.new(WebKit.WebView, network_session=self.network_session)
    ...
    def on_webview_popup(self, widget, navigation_action):
        ...
        view = GObject.new(WebKit.WebView, related_view=widget)
...
class WebPopupDialog(ModalDialog):
    ...
    def on_new_webview_popup(self, webview, navigation_action):
        """Handles web popups created by this dialog's webview"""
        uri = navigation_action.get_request().get_uri()
        view = GObject.new(WebKit.WebView, related_view=webview)
        view.load_uri(uri)
